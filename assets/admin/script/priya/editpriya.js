...
{   
	...
	initSample(); 	
	$("#txt_title").focus();
	 if(localStorage.getItem("priya_id")!=null && localStorage.getItem("priya_title")!=null && localStorage.getItem("priya_sub_title")!=null && localStorage.getItem("priya_description")!=null && localStorage.getItem("priya_image_name")!=null )
	 {
		
		$("#txt_title").val(localStorage.getItem("priya_title"));
		$("#txt_sub_title").val(localStorage.getItem("priya_sub_title"));
		CKEDITOR.instances.editor.setData(localStorage.getItem("priya_description")); 
		if(localStorage.getItem('priya_image_name')!='')
		 $("#img_preview").html('<img  style="width:100%" src="'+baseurl+'upload/'+localStorage.getItem('priya_image_name')+'" alt="Uploading...."/>');
	 }	
	...
	$("#file_image").change(function()
		{
				...
				else
				{
					   ...
					   /* var files = !!this.files ? this.files : [];
						...
						$.ajax
						({
							url:''+baseurl+'priyaupload',  	
							type: "POST", 
							data: new FormData(),	
							data:  new FormData(document.getElementById("frm_priya")),
							contentType: false,       		
							cache: false,					
							processData:false,  							
									 ...
									 else 
									 {
										...
										for(i in v)
										{
											if(i=='file_name')
											{
												...
												localStorage.setItem("priya_image_name",v[i]);
												$("#img_preview").html('');
	...
	{
		 localStorage.setItem("priya_image_name","");
		 $("#file_image").val('');
		 $("#img_preview").html('');
	...
	$("#btn_update").click(function()
	{
		          ...
		          $.ajax
						  ({
							url:''+baseurl+'priyaupdate',
							type: "POST", 
							data:{priya_id:localStorage.getItem("priya_id"),priya_title:$("#txt_title").val(),priya_sub_title:$("#txt_sub_title").val(),priya_description:CKEDITOR.instances.editor.getData(),priya_image_name:localStorage.getItem("priya_image_name"),tag:'update'},
							cache: false,	
