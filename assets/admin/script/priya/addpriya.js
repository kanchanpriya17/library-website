	...
	$("#txt_title").focus();
		...
		$("#btn_save").click(function()
		{
				...
				else
				{
			      ...
			      $.ajax
						  ({
							url:''+baseurl+'priyasave',
							type: "POST", 
							data:{priya_title:$("#txt_title").val(),priya_sub_title:$("#txt_sub_title").val(),priya_description:CKEDITOR.instances.editor.getData(),priya_image_name:$("#hid_upload").val(),tag:'save'},
							cache: false,							
							success: function(data)  		
							{
								var data	=	$.parseJSON(data);	
