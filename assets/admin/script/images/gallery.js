...
{   
	...
	{
		window.location.href=''+baseurl+'admin/addgallery1';
	...
	{
		window.location.href=''+baseurl+'admin/searchgallery1?s='+$("#txt_search").val()+'';
...
function edit(x)
{
	   ...
	   $.ajax
		  ({
			url:''+baseurl+'getgallerydetails1',
			type: "POST", 
			data:{id:x},
			cache: false,							
			success: function(data)  		
			{
				...
				$.each(data, function(k,v) 
				{
					 if(k=='success')
					 {
						 ...
						 window.location.href=""+baseurl+"admin/editgallery1";
					 }
