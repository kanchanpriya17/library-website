	...
	$("#txt_title").focus();
		...
		$("#btn_save").click(function()
		{
				...
				else
				{
			      ...
			      $.ajax
						  ({
							url:''+baseurl+'awardsave',
							type: "POST", 
							data:{award_title:$("#txt_title").val(),award_sub_title:$("#txt_sub_title").val(),award_description:CKEDITOR.instances.editor.getData(),award_image_name:$("#hid_upload").val(),tag:'save'},
							cache: false,							
							success: function(data)  		
							{
								var data	=	$.parseJSON(data);	
