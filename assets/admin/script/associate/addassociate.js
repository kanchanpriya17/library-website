	...
	$("#txt_title").focus();
		...
		$("#btn_save").click(function()
		{
				...
				else
				{
			      ...
			      $.ajax
						  ({
							url:''+baseurl+'associatesave',
							type: "POST", 
							data:{associate_title:$("#txt_title").val(),associate_sub_title:$("#txt_sub_title").val(),associate_description:CKEDITOR.instances.editor.getData(),associate_image_name:$("#hid_upload").val(),tag:'save'},
							cache: false,							
							success: function(data)  		
							{
								var data	=	$.parseJSON(data);	
