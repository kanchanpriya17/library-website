...
{   
   ...
   $(".sidebar-menu li").each(function () 
	...
	$("#logo").css('background','#1e282c');
	$("#logo").css('border-left','3px solid #3c8dbc');
	...
	$("#file_image").change(function()
		{
				...
				{      $("#img_preview").html('<img   src="'+baseurl+'assets/admin/images/ajax-loader.gif" alt="Uploading...."/>');
					   /* var files = !!this.files ? this.files : [];
						...
						$.ajax
						({
							url:''+baseurl+'logoupload',  	
							type: "POST", 
							data: new FormData(),	
							data:  new FormData(document.getElementById("frm_logo")),
							contentType: false,       		
							cache: false,					
							processData:false,  							
