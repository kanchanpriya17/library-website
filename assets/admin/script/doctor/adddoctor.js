	...
	$("#txt_title").focus();
		...
		$("#btn_save").click(function()
		{
				...
				else
				{
			      ...
			      $.ajax
						({
							url:''+baseurl+'doctorsave',
							type: "POST", 
							data:{name:$("#txt_title").val(),designation:$("#txt_sub_title").val(),description:CKEDITOR.instances.editor.getData(),image_name:$("#hid_upload").val(),tag:'save'},
							/*data:{name:$("#txt_title").val(),designation:$("#txt_sub_title").val(),description:CKEDITOR.instances.editor.getData(),tag:'save'},*/
							cache: false,							
							success: function(data)  		
							{
								var data	=	$.parseJSON(data);	
