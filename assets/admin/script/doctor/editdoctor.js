...
{   
	...
	$("#txt_title").focus();
	 ...
	 if(localStorage.getItem("doctor_id")!=null && localStorage.getItem("doctor_name")!=null && localStorage.getItem("doctor_designation")!=null && localStorage.getItem("doctor_description")!=null && localStorage.getItem("doctor_image_name")!=null)
	 {
		
		$("#txt_title").val(localStorage.getItem("doctor_name"));
		$("#txt_sub_title").val(localStorage.getItem("doctor_designation"));
		CKEDITOR.instances.editor.setData(localStorage.getItem("doctor_description")); 
		if(localStorage.getItem('doctor_image_name')!='')
		 $("#img_preview").html('<img  style="width:100%" src="'+baseurl+'upload/thumb/'+localStorage.getItem('doctor_image_name')+'" alt="Uploading...."/>');
									 ...
									 else 
									 {
										...
										for(i in v)
										{
											if(i=='file_name')
											{
												...
												localStorage.setItem("doctor_image_name",v[i]);
												$("#img_preview").html();
	...
	{
		 localStorage.setItem("doctor_image_name","");
		 $("#file_image").val('');
		 $("#img_preview").html('');
	...
	$("#btn_update").click(function()
	{
		          ...
		          $.ajax
						  ({
							url:''+baseurl+'doctorupdate',
							type: "POST", 
							data:{id:localStorage.getItem("doctor_id"),name:$("#txt_title").val(),designation:$("#txt_sub_title").val(),description:CKEDITOR.instances.editor.getData(),image_name:localStorage.getItem("doctor_image_name"),tag:'update'},
							cache: false,	
