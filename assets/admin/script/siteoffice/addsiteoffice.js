	...
	$("#txt_title").focus();
		...
		$("#btn_save").click(function()
		{
				...
				else
				{
			      ...
			      $.ajax
						  ({
							url:''+baseurl+'siteofficesave',
							type: "POST", 
							data:{siteoffice_title:$("#txt_title").val(),siteoffice_sub_title:$("#txt_sub_title").val(),siteoffice_description:CKEDITOR.instances.editor.getData(),siteoffice_image_name:$("#hid_upload").val(),tag:'save'},
							cache: false,							
							success: function(data)  		
							{
								var data	=	$.parseJSON(data);	
