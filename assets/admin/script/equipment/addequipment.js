	...
	$("#txt_title").focus();
		...
		$("#btn_save").click(function()
		{
				...
				else
				{
			      ...
			      $.ajax
						  ({
							url:''+baseurl+'equipmentsave',
							type: "POST", 
							data:{equipment_title:$("#txt_title").val(),equipment_sub_title:$("#txt_sub_title").val(),equipment_description:CKEDITOR.instances.editor.getData(),equipment_image_name:$("#hid_upload").val(),tag:'save'},
							cache: false,							
							success: function(data)  		
							{
								var data	=	$.parseJSON(data);	
