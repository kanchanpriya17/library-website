...
{   
	...
	$("#txt_title").focus();
	 ...
	 if(localStorage.getItem("news_id")!=null && localStorage.getItem("news_title")!=null && localStorage.getItem("news_sub_title")!=null && localStorage.getItem("news_description")!=null && localStorage.getItem("news_image_name")!=null)
	 {
		
		$("#txt_title").val(localStorage.getItem("news_title"));
		$("#txt_sub_title").val(localStorage.getItem("news_sub_title"));
		CKEDITOR.instances.editor.setData(localStorage.getItem("news_description")); 
		if(localStorage.getItem('news_image_name')!='')
		 $("#img_preview").html('<img  style="width:100%" src="'+baseurl+'upload/thumb/'+localStorage.getItem('news_image_name')+'" alt="Uploading...."/>');
									 ...
									 else 
									 {
										...
										for(i in v)
										{
											if(i=='file_name')
											{
												...
												localStorage.setItem("news_image_name",v[i]);
												$("#img_preview").html();
	...
	{
		 localStorage.setItem("news_image_name","");
		 $("#file_image").val('');
		 $("#img_preview").html('');
	...
	$("#btn_update").click(function()
	{
		          ...
		          $.ajax
						  ({
							url:''+baseurl+'newsupdate',
							type: "POST", 
							data:{id:localStorage.getItem("news_id"),title:$("#txt_title").val(),sub_title:$("#txt_sub_title").val(),description:CKEDITOR.instances.editor.getData(),image_name:localStorage.getItem("news_image_name"),tag:'update'},
							cache: false,	
