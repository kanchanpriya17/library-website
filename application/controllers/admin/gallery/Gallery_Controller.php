...
class Gallery_Controller extends CI_Controller 
{
	 public function __construct()
	 {
			...
			$this->load->model('admin/gallery/Gallery_Model');
	...
	public function index()
	{
		...
		{ 
			   ...
			   $this->load->view('admin/gallery/Gallery_View',$result);
	    }		  
	    else
		{
	...
	public function addnew()
	{
		...
		{
			   $arr=array();
               $arr['page_title']='Add Products';			   
			   $result['records'] =array();
			   array_push($result['records'],$arr);
			  $this->load->view('admin/gallery/Add_Gallery_View',$result);
	    }		  
	    else
	     redirect('admin');
		 ...
		 if ($this->session->userdata('is_user_login')) 
		{
			//$this->form_validation->set_rules('title', 'Title', 'trim|required|xss_clean');
			 ...
			 $arr = array(
							...
							'gallery_sub_title' => $this->input->post('sub_title'),
	...
	{ 
		...
		{
			   $arr=array();
               $arr['page_title']='Edit Products';			   
			   $result['records'] =array();
			   array_push($result['records'],$arr);  
			 $this->load->view('admin/gallery/Edit_Gallery_View',$result);
	...
	public function search()
	{
		...
		{ 
              ...
              $result["links"] = explode(',',$str_links ); 
			   ...
			   $this->load->view('admin/gallery/Search_Gallery_View',$result);
	    }		  
	    else
		{
