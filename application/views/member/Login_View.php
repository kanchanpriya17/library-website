...
<html>
 <head>
    <meta charset="UTF-8">
    <title>Login | Integrity First</title>
    ...
    <script src="<?php echo base_url();?>assets/member/script/login.js"></script>
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
       <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>upload/<?php echo $settings[8]['value']; ?>" alt="Image" /></a>
      </div>
      <div class="login-box-body">
        <p class="login-box-msg">MEMBER LOGIN</p>
        <form action="" method="post" id="frm">
			  <div class="form-group has-feedback">
				<input type="text" id="txt_user_name" class="form-control" placeholder="User ID" maxlength="30"/>
