...
@media (max-width:320px)
{
	...
	#btn_search
	{
									 ...
									 if (isset($records))
									 {
										 ...
										 if($ctr==0)
                                          ...
                                          foreach($records as $k=>$v)
										  {
											...
											<tr>
											<td><?php echo $ctr++; ?></td>
											<!--<td><?php //echo $records[$k]['news_id']; ?></td>-->
											<td><?php echo substr(strip_tags($records[$k]['news_title']),0,20)."...";?></td>
											<!--<td><?php echo substr(strip_tags($records[$k]['news_sub_title']),0,20)."...";?></td>-->
											
											<td><?php echo substr(strip_tags($records[$k]['news_description']),0,25)."..."; ?></td>
								<td><span class='badge bg-green' id='btn_edit' onclick='edit("<?php echo $records[$k]['news_id']?>")'>Edit</span>
								<span class='badge bg-maroon' id='btn_edit' onclick='del("<?php echo $records[$k]['news_id']?>")'>Delete</span></td>
											</tr>
                                          <?php	
                                              }										  
										  }
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/news/news.js" type="text/javascript"></script>
<?php 
