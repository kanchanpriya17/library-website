...
?>
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1 id="form_header">Change Logo</h1>
				<div id="header2"></div>
				<div class="row">
					<div class="col-md-8">
					...
					<div class="col-md-4">
						<div class="box box-primary">
							...
							<?php if(!empty($settings[8]['value'])){?>
							  <img src="<?php echo base_url(); ?>upload/thumb/<?php echo $settings[8]['value']; ?>" alt="Image" />
							<?php } ?>   
							</div>
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/logo/logo.js" type="text/javascript"></script>
<?php 
