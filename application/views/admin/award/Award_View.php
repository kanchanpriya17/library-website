...

{
...

	{
										 ...
										 if($ctr==0)
...

										  {
											...
											<!--	<td><?php //echo $records[$k]['award_id']; ?></td>-->
												...
												<td><?php echo substr($records[$k]['award_title'],0,25)."...";?></td>

												<td><?php echo substr($records[$k]['award_sub_title'],0,25)."...";?></td>

												<td><?php echo strip_tags(substr($records[$k]['award_description'],0,20)."...");?></td>					

								<td><span class='badge bg-green' id='btn_edit' onclick='edit("<?php echo $records[$k]['award_id']?>")'>Edit</span>

								<span class='badge bg-maroon' id='btn_edit' onclick='del("<?php echo $records[$k]['award_id']?>")'>Delete</span></td>
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/award/award.js" type="text/javascript"></script>
