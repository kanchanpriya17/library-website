...
?>
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1 id="form_header">Edit Video Category</h1>
				<div id="header2"></div>
				<div class="row">
					<div class="col-md-8">
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/video-category/editvideocategory.js" type="text/javascript"></script>
<?php 
