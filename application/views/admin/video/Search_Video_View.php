...
@media (max-width:320px)
{
	...
	#btn_search
	{
							...
							<div class="box-header">
								...
								<div class="box-tools" style="margin-top:35px;">
									<div class="input-group">
										<input type="text" name="table_search" class="form-control input-sm pull-right" id="txt_search" placeholder="Search"/>
										 ...
										 if($ctr==0)
                                          ...
                                          foreach($records as $k=>$v)
										  {
											...
											<tr>
												...
												<td><?php echo substr($records[$k]['video_title'],0,20)."...";?></td>											
												...
												<td>
												<?php 
												  if($records[$k]['approved']=='1')
													  echo "approved";
												  else if($records[$k]['approved']=='2')
													 echo "Disapproved"; 
												  else
													  echo "Pending"; 
												?>
												</td>
												<td><?php echo substr(strip_tags($records[$k]['user_id']),0,10)."..."; ?></td>
												<td><?php echo substr(strip_tags($records[$k]['name']),0,10)."..."; ?></td>
	  ...
	  <script src="<?php echo base_url();?>assets/admin/script/video/video.js" type="text/javascript"></script>
<?php 
