...
?>
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1 id="form_header">Edit Other Products</h1>
				<div id="header2"></div>
				<div class="row">
					<div class="col-md-8">
							...
							<form id="frm_post" method="post" enctype="multipart/form-data">
								...
								<!--	<div class="form-group">
									...
									<!--<div class="form-group">
										...
										<input type="text" class="form-control" id="event_venue1" name="event_venue1" placeholder="Enter Bowling Style">
									</div>
									<div class="form-group">
										<label>Teams</label>
	...
	<script src="<?php echo base_url();?>assets/admin/script/brand/editbrand.js" type="text/javascript"></script>
<?php 
