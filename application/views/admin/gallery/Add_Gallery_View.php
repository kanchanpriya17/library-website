...
?>
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1 id="form_header">Add Product</h1>
				<div id="header2"></div>
				<div class="row">
					<div class="col-md-8">
						<div class="box box-primary">
							...
							<form id="frm_gallery" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="form-group">
										<label>Title</label>
										<input type="text" class="form-control" id="txt_title" name="title" placeholder="Enter Title">
									</div>
									<div class="form-group">
										<label>Sub Title</label>
										<input type="text" class="form-control" id="txt_sub_title" name="sub_title" placeholder="Enter Sub Title">
									</div>
									<div class="form-group">
										<label >Image</label>
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/gallery/addgallery.js" type="text/javascript"></script>
<?php 
