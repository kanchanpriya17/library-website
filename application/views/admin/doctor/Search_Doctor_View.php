...
@media (max-width:320px)
{
	...
	#btn_search
	{
									 ...
									 if (isset($records))
									 {
										 ...
										 if(!is_numeric($no))
                                          ...
                                          foreach($records as $k=>$v)
										  {
											...
											<tr>
											<td><?php echo $ctr++; ?></td>
											<td><?php echo $records[$k]['doctor_id']; ?></td>
											<td><?php echo substr(strip_tags($records[$k]['doctor_name']),0,20)."...";?></td>
											<td><?php echo substr(strip_tags($records[$k]['doctor_designation']),0,20)."...";?></td>											
											<td><?php echo substr(strip_tags($records[$k]['doctor_description']),0,25)."..."; ?></td>
								<td><span class='badge bg-green' id='btn_edit' onclick='edit("<?php echo $records[$k]['doctor_id']?>")'>Edit</span>
								<span class='badge bg-maroon' id='btn_edit' onclick='del("<?php echo $records[$k]['doctor_id']?>")'>Delete</span></td>
											</tr>
                                          <?php	
                                              }										  
										  }
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/doctor/doctor.js" type="text/javascript"></script>
<?php 
