...

										  {
                                            if($k < sizeof($records)-1)
                                           {
											...
											<tr>
											    ...
											    <td><?php echo $ctr++; ?></td>
												<td><?php echo substr($records[$k]['textname'],0,25)."...";?></td>
												<td><?php echo substr($records[$k]['textemail'],0,25)."...";?></td>
												<td><?php echo substr($records[$k]['textmobile'],0,25)."...";?></td>
														
								<td><span class='badge bg-green' id='btn_edit' onclick='edit("<?php echo $records[$k]['id'] ?>")'></span>
...
?>
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/visiter/visiter.js" type="text/javascript"></script>
<?php 
