...
$(document).ready(function()
{
	...
	DataTable({
                ...
                buttons: [
                    {extend: 'copy', title: 'Apis', exportOptions: {columns: [ 0, 1,2,3,4] }},
                    {extend: 'csv', title: 'Apis', exportOptions: {columns: [  0, 1,2,3,4] }},
                    {extend: 'excel', title: 'Apis', exportOptions: {columns: [  0, 1,2,3,4] }},
                    {extend: 'pdf', title: 'Apis', exportOptions: {columns: [  0, 1,2,3,4] }},							 									
                    {
						 extend: 'print',
						 title: 'Stores',
                         exportOptions: 
