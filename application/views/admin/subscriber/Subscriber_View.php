...
@media (max-width:320px)
{
	...
	#btn_search
	{
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1>Contact Us Form Information</h1>
				<div id="header"></div>
				<div class="row">
					<div class="col-xs-12">	
										 ...
										 if(!is_numeric($no))
                                          ...
                                          foreach($records as $k=>$v)
										  {
											...
											<tr>
                                                ...
                                                <td><?php echo substr($records[$k]['email'],0,25)."...";?></td>
											     <td><?php echo substr($records[$k]['subject'],0,25)."...";?></td>
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/subscriber/subscriber.js" type="text/javascript"></script>
<?php 
