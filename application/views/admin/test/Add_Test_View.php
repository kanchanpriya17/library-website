...
?>
        ...
        <div class="content-wrapper" id="div_main">
			<section class="content-header" id="slider_form">
				<h1 id="form_header">Add Upcoming Project Gallery</h1>
				<div id="header2"></div>
				<div class="row">
					<div class="col-md-8">
						<div class="box box-primary">
							...
							<form id="frm_page" method="post" enctype="multipart/form-data">
								<div class="box-body">
									...
									<div class="form-group">
										<label>Gallery Image sub Title</label>
										
										
										<!--<input type="text" class="form-control" id="txt_sub_title" placeholder="Enter Date of Event">-->
										
										 <input type="text" class="form-control" id="txt_sub_title">
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/test/addtest.js" type="text/javascript"></script>
