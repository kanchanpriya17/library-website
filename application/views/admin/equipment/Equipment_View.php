										 ...
										 if($ctr==0)
...

										  {
											...
											<!--	<td><?php //echo $records[$k]['award_id']; ?></td>-->
												...
												<td><?php echo substr($records[$k]['equipment_title'],0,25)."...";?></td>

												<td><?php echo substr($records[$k]['equipment_sub_title'],0,25)."...";?></td>

												<td><?php echo strip_tags(substr($records[$k]['equipment_description'],0,20)."...");?></td>					

								<td><span class='badge bg-green' id='btn_edit' onclick='edit("<?php echo $records[$k]['equipment_id']?>")'>Edit</span>

								<span class='badge bg-maroon' id='btn_edit' onclick='del("<?php echo $records[$k]['equipment_id']?>")'>Delete</span></td>
