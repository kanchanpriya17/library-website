...
?>
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1 id="form_header">Edit Equipment</h1>
				<div id="header2"></div>
				<div class="row">
					<div class="col-md-8">
						<div class="box box-primary">
							...
							<form id="frm_equipment" method="post" enctype="multipart/form-data">
								<div class="box-body">
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/equipment/editequipment.js" type="text/javascript"></script>
<?php 
