...
?>
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1 id="form_header">Edit Associate</h1>
				<div id="header2"></div>
				<div class="row">
					<div class="col-md-8">
						<div class="box box-primary">
							...
							<form id="frm_associate" method="post" enctype="multipart/form-data">
								<div class="box-body">
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/associate/editassociate.js" type="text/javascript"></script>
<?php 
