...
@media (max-width:320px)
{
	...
	#btn_search
	{
										 ...
										 if($ctr==0)
                                          ...
                                          foreach($records as $k=>$v)
										  {
											...
											<tr>
												...
												<td><?php echo substr($records[$k]['title'],0,25)."...";?></td>
												<td><?php echo substr($records[$k]['sub_title'],0,25)."...";?></td>
												<td><?php echo strip_tags(substr($records[$k]['description'],0,20)."...");?></td>					
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/page/page.js" type="text/javascript"></script>
<?php 
