...
?>
      ...
      <div class="content-wrapper" id="div_main">
				...
				<h1 id="form_header">Edit Page</h1>
							...
							<form id="frm_page" method="post" enctype="multipart/form-data">
								...
								<div class="box-body">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="txt_title" placeholder="Enter Title" readonly>
									...
									<div class="form-group">
										<label >Header Image</label>
										 <input type="hidden" id="hid_upload1" name="hid_upload1" value=""/>
										 <input type="file" id="file_image1" name="file_image1">
						...
						<div class="row">
							...
							<div class="box box-primary">
								...
								<div class="box-header" >
									...
									<h3 class="box-title" >Select Parent Page</h3>

									<div class="form-group">

											<select class="form-control" id="slct_page">
					   ...
					   <div class="row">
							<div class="box box-primary">
								<div class="box-header text-center">
									...
									<div class="form-group">
											<div id="img_preview1" style="padding:10px">
							                </div>
											<div class="box-footer" >											       
														<button class="btn bg-maroon btn-sm btn-flat margin" id="btn_remove1" >Remove</button>												
											</div>
									</div>
								</div>
							</div>
	 ...
	 <script src="<?php echo base_url();?>assets/admin/script/page/editpage.js" type="text/javascript"></script>
