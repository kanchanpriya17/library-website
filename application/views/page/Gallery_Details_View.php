...
?>
<?php 
 if($service_details[0]['title']!='')
	$title=$service_details[0]['title'];
 else
	$title='';  
	
 if($service_details[0]['description']!='')
	$description=$service_details[0]['description'];
 else
	$description=''; 	
	
	
if($service_details[0]['image_name']!='')
	 $image=$service_details[0]['image_name'];
else 
	$image='' ;
?>
 ...
 <div class="row">
    ...
    <div class="container">
                ...
                <div class="col-md-12 col-sm-12">
                  <img src="<?php //echo base_url(); ?>upload/<?php //echo $service_details[0]['image_name'];?>"/ class="img-responsive"> 
...
<div class="container content-sm">
            ...
            <div class="divider">
				...
				<a class="img-responsive" rel="prettyPhoto[gallery2]" href="<?php echo base_url(); ?>upload/<?php echo $service_details[0]['image_name'];?>" data-lightbox="example-set" title="Click on the right side of the image to move forward.">
		      <img src="<?php echo base_url(); ?>upload/<?php echo $service_details[0]['image_name'];?>"/ class="img-responsive">
		      </a>
					</div>
					<div class="col-md-8">
